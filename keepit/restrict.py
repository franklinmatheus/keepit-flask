...
from keepit.db_analysis import get_balance, get_expenses_info, get_resources_info
...
def home():
    ...
    revenues_info = get_resources_info(session.get('user_id'),curr_date.month,curr_date.year)
